...
function LandingPage({ onLogin, onCreateAccount }) {
  ...
  const renderTabContent = () => {
    ...
    return (
      <div className="landing-tab-content landing-tab-panel overview-content">
        {/* CHANGED: Main Header updated from MangoSort to MangPa-in */}
        <h1 className="landing-main-title animate-title">MangPa-in</h1>
        ...
        {/* CHANGED: Paragraph description text updated from MangoSort to MangPa-in */}
        <p className="landing-description">
          MangPa-in is an automated cyber-physical prototype designed to streamline post-harvest processing
  ...
  return (
    <div className="landing-page">
      <header className="dashboard-header landing-header">
        <div className="header-content landing-header-content">
          <div className="landing-id">
            {/* CHANGED: Logo Text updated from MangoSort to MangPa-in */}
            <h1 className="landing-logo-title">MangPa-in</h1>
          </div>
      ...
      {/* CHANGED: Footer Copy updated from MangoSort to MangPa-in */}
      <footer className="landing-footer">© 2026 MangPa-in - Built for Carabao Mango Quality Optimization</footer>
    </div>
  );
}
