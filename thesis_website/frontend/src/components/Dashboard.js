  ...
  const handleToggleSession = async () => {
    ...
    if (turningOn) {
      ...
      try {
        ...
        await fetch('http://localhost:5000/api/clear-sensor-data', { method: 'POST' }).catch(err => console.error('Failed to clear sensor data:', err));
      ...
      try {
        ...
        if (res.ok) {
          ...
          fetch('http://localhost:5000/api/clear-sensor-data', { method: 'POST' }).catch(err => console.error('Failed to clear sensor data:', err));
